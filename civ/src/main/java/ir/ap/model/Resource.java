...
public enum Resource {
    ...
    SHEEP(4,1,0,0,new ArrayList<>(Arrays.asList(new Enum[]{TerrainType.PLAINS,TerrainType.GRASSLAND,TerrainType.DESERT,TerrainType.HILL})),Improvement.PASTURE,null),
    ...
    IRON(10,0,1,0,new ArrayList<>(Arrays.asList(new Enum[]{TerrainType.TUNDRA,TerrainType.PLAINS, TerrainType.DESERT,TerrainType.HILL,TerrainType.GRASSLAND,TerrainType.SNOW})),Improvement.MINE,Technology.IRON_WORKING),
    ...
    IVORY(19,0,0,2,new ArrayList<>(Arrays.asList(new Enum[]{TerrainType.PLAINS})),Improvement.CAMP,null),
    MARBLE(20,0,0,2,new ArrayList<>(Arrays.asList(new Enum[]{TerrainType.TUNDRA,TerrainType.PLAINS,TerrainType.DESERT,TerrainType.GRASSLAND,TerrainType.HILL})),Improvement.QUARRY,null),
    ...
    Resource(int id, int foodYield, int productionYield, int goldYield, ArrayList<Enum<?>> canBeFoundOn, Improvement improvementRequired, Technology technologyRequired)
    {
        this.id = id;
