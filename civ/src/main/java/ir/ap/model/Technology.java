...
public enum Technology {
    ...
    THE_WHEEL(9,55, new ArrayList<>(Arrays.asList(new Technology[]{Technology.ANIMAL_HUSBANDRY})),Era.ANCIENT,new ArrayList<>(Arrays.asList(new Object[]{UnitType.CHARIOT_ARCHER,UnitType.ARCHER,BuildingType.WATER_MILL,UnitAction.BUILD_ROAD}))),
    ...
    IRONWORKING(14,150, new ArrayList<>(Arrays.asList(new Technology[]{Technology.BRONZE_WORKING})),Era.CLASSICAL,new ArrayList<>(Arrays.asList(new Object[]{UnitType.SWORDSMAN,BuildingType.ARMORY,Resource.IRON}))),
    ...
    CHEMISTRY(30,900, new ArrayList<>(Arrays.asList(new Technology[]{Technology.GUNPOWDER})),Era.RENAISSANCE,new ArrayList<>(Arrays.asList(new Object[]{Technology.IRONWORKING}))),
